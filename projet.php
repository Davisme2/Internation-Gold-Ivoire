...
<!--loader-->
    ...
    <div class="container">
      <div class="row title">
      	<div class="title_row">
      		<h1 data-title="Project"><span>Nos Projets</span></h1>      		
      	</div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-6 offset-lg-3 mb-30">
          <div class="heading-box">
            <h2><span>Nos </span> Réalisations</h2>
            <p>
				Nous observons au-délà des horizons. Notre objectif est de devenir un IMPORTANT PARTENAIRE DE CONSTRUCTION opérant
				dans le BTP et dans l'IMMOBILIER
			</p>
          </div>
					...
					<div class="row">
						...
						<ul class="container-filter categories-filter">
							...
							<li>
								<a class="categories" data-filter=".realisation">realisation</a>
							</li>
							<li>
								<a class="categories" data-filter=".chantier">Chantier</a>
							</li>
							<li>
								<a class="categories" data-filter=".equipe">Equipe</a>
							</li>
						</ul>
					</div>
					</div>
					...
					<div class="row container-grid nf-col-3">
						...
						<div class="nf-item chantier coffee spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Construction d'un immeuble R+6</a></h4>
								</div>
							</div>
						</div>

						<div class="nf-item chantier spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Construction d'une salle de classe</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item chantier coffee spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Fonçage de cable</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item chantier spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Fondations pour poteau isolés et amorce</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item chantier spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Pose de pavé autobloquant sur la gare à péage de Thomasset</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item realisation spacing">
							<div class="item-box">
								...
								<div class="gallery-heading">
									<h4><a href="#">Base vie péage d'ATTINGUIE</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item realisation spacing">
							<div class="item-box">
								<a> <img alt="1" src="assets/images/project/project_7.jpg" class="item-container"> </a>
								<div class="link-zoom">
									<a href="project-details.html" class="project_links"> <i class="fa fa-link"> </i> </a>
									<a href="assets/images/project/project_7.jpg" class="fancylight" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								</div>
								<div class="gallery-heading">
									<h4><a href="#">Pose de revêtement en alucobon pour la BASE-VIE 2</a></h4>
								</div>
							</div>
						</div>
						...
						<div class="nf-item equipe spacing">
							<div class="item-box">
								<a> <img alt="1" src="assets/images/project/project_8.jpg" class="item-container"> </a>
								<div class="link-zoom">
									<a href="project-details.html" class="project_links"> <i class="fa fa-link"> </i> </a>
									<a href="assets/images/project/project_8.jpg" class="fancylight" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								</div>
								<div class="gallery-heading">
									<h4><a href="#">Projet de construction d'une BASE-VIE pour le péage d'ATTIGUE</a></h4>
								</div>
							</div>
						</div>
						<div class="nf-item equipe spacing">
							<div class="item-box">
								<a> <img alt="1" src="assets/images/project/project_9.jpg" class="item-container"> </a>
								<div class="link-zoom">
									<a href="project-details.html" class="project_links"> <i class="fa fa-link"> </i> </a>
									<a href="assets/images/project/project_9.jpg" class="fancylight" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								</div>
								<div class="gallery-heading">
									<h4><a href="#">Réunion technique pour le Télépéage d'ATTINGUIE</a></h4>
								</div>
							</div>
						</div>
						<div class="nf-item equipe spacing">
							<div class="item-box">
								<a> <img alt="1" src="assets/images/project/project_10.jpg" class="item-container"> </a>
								<div class="link-zoom">
									<a href="project-details.html" class="project_links"> <i class="fa fa-link"> </i> </a>
									<a href="assets/images/project/project_10.jpg" class="fancylight" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								</div>
								<div class="gallery-heading">
									<h4><a href="#">Equipe de travail</a></h4>
								</div>
							</div>
						</div>
						<div class="nf-item equipe spacing">
							<div class="item-box">
								<a> <img alt="1" src="assets/images/project/project_11.jpg" class="item-container"> </a>
								<div class="link-zoom">
									<a href="project-details.html" class="project_links"> <i class="fa fa-link"> </i> </a>
									<a href="assets/images/project/project_11.jpg" class="fancylight" data-fancybox-group="light" > <i class="fa fa-search-plus"></i> </a>
								</div>
								<div class="gallery-heading">
									<h4><a href="#">Travaux de couplage des socles de Télépéage sur les gares d'ATTINGUIE et de SINGROBO</a></h4>
								</div>
							</div>
						</div>
