...
<head>
    ...
    <div class="container">
      <div class="row title">
      	<div class="title_row">
      		<h1 data-title="About"><span>A propos</span></h1>
      	</div>
				...
				<div class="row pb-60 pb-xs-40">
					<div class="col-md-8 offset-md-2">
						<div class="sec_hedding text-center">
							...
							<p>
								<strong>ICF</strong> (<strong>I</strong>voire <strong>C</strong>onstruction & <strong>F</strong>ourniture SARL) est une entreprise de bâtiment & divers dont 
								la compétence et l'expertise ne sont plus à prouver. Elle cumule à son actif plusieurs chantiers
								soldé par le succès et entrevoie rester toujours présente dans la course pour l'execellence et 
								performance dans son domaine.
							</p>
						</div>
					</div>
				</div>
