...
<!--loader-->
  ...
  <section class="inner-intro bg-img light-color overlay-before parallax-background">
    <div class="container">
      <div class="row title">
      	<div class="title_row">
      		<h1 data-title="Services"><span>Nos services</span></h1>
      	</div>
      </div>
    </div>
  </section>
				...
				<div class="row text-center mb-30">
					<div class="col-sm-12">
						<div class="sec_hedding">
							<h2><span>Nos domaines</span> d'activité</h2>
						...
						<div class="maine_box">
							...
							<div class="box_detail">
								...
								<div class="datail_show">
									<h3>La Construction Bâtiment</h3>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 mb-xs-30 margin_bott">
						<div class="maine_box">
							...
							<div class="box_detail">
								...
								<div class="datail_show">
									<h3>La Maintenance d'Ouvrages Publiques & Privé</h3>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 mb-xs-30">
						<div class="maine_box">
							...
							<div class="box_detail">
								...
								<div class="datail_show">
									<h3>Renovation & Réhabilitation d'Ouvrages</h3>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 margin_reponsive">
						<div class="maine_box">
							...
							<div class="box_detail">
								...
								<div class="datail_show">
									<h3>Extension des fonctionalités et des capacité d'accueil d'un bâtiments </h3>
								</div>
							</div>
